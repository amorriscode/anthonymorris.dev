      ...
      <header className="mx-auto max-w-3xl space-y-5">
        ...
        <PageSummary>
          ...
          <p>
            ...
            >
              It&apos;s not hard to find using a simple search (but don&apos;t
              ask me to verify the accuracy).
            </a>
          </p>
          ...
          <p>
            ...
            use. I can promise there will be a whole lot of random stuff. Either
            way, hopefully it provides a fun place for me to ponder the inner
