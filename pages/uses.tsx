          ...
          <article className="space-y-8">
            <PageSummary>
              <p>
                ...
                . These are the tools I like to use to be productive and have
                fun.
              </p>
            </PageSummary>
            ...
            <section className="prose">
              ...
              <ul>
                ...
                <li>
                  I like using <a href="https://www.oakmeditation.com">Oak</a>{' '}
                  to practice mindfulness but have also been using{' '}
            ...
            <section className="prose">
              ...
              <ul>
                ...
                <li>
                  ...
                  <a href="https://remarkable.com">reMarkable</a> has been a
                  good replacement. I love the ability to organize and not waste
                  paper. But I miss my notebooks.
                </li>

                <li>
                  I take photographs with a{' '}
                  <a href="https://en.wikipedia.org/wiki/Canon_A-1">
                    Canon A-1
                  </a>{' '}
                  film camera.
                </li>
