    ...
    <>
      ...
      <PageSummary>
        ...
        <p>
          ...
          growth mindset allows you to utilize your failures. I decided to make
          a <span className="font-bold">failure journal</span>.
        </p>

        <p>
          This is a place for me to reflect on my failures. To learn from them.
          More importantly, it&apos;s a place to{' '}
      ...
      {/* <div className="w-full border-t border-stone-500 mb-12"></div> */}
